...
const features = [
  { title: "Built for Birmingham Business", body: "The UK's second city deserves a digital presence that reflects its ambition. We design for Birmingham businesses that want to lead — not follow.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
  { title: "Custom, Not Templated", body: "Every website we create is designed from scratch — informed by your brand, your sector, and the specific dynamics of the Birmingham market.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg> },
  { title: "Responsive Website Design", body: "Flawless across every device, from desktop workstations in the Jewellery Quarter to mobile browsing across the West Midlands.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
  { title: "Conversion-Focused", body: "Strategic UX and persuasive design working together — sites that turn Birmingham visitors into loyal clients.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 8 15 12 12 16"/><line x1="8" y1="12" x2="15" y2="12"/></svg> },
  { title: "SEO for Birmingham", body: "Local and technical SEO built in from launch — ensuring your Birmingham business ranks for the searches that drive real enquiries.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg> },
  { title: "Ongoing Partnership", body: "We offer retained partnerships for Birmingham businesses that want consistent, strategic stewardship of their digital presence.", icon: <svg className="w-8 h-8 text-[#B08D57]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
];

export default function WebDesignBirminghamPage() {
  const projects = getProjectsForCity("birmingham");
  const faqs = locationFAQs.birmingham;
  const heroImage = locationImages.birmingham;
  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span className="text-[#B08D57] text-[0.68rem] tracking-[0.22em] uppercase font-sans">Birmingham</span>
                </div>
                <h1 className="font-serif-display text-[#F6F1E8] leading-[1.08] mb-6" style={{ fontSize: "clamp(2.2rem, 4vw, 3.2rem)" }}>
                  Modern Web Design in Birmingham Built Around Your <em className="text-[#B08D57]">Business</em>
                </h1>
                <p className="text-[#F6F1E8]/70 text-[0.9rem] leading-relaxed font-sans font-light mb-8 max-w-[52ch]">
                  Grow your online presence with our Web Design Birmingham services. We create custom websites that are visually engaging, SEO-friendly, and designed to help Birmingham businesses generate more enquiries and long-term growth.
                </p>
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
              <div className="lg:col-span-5">
                ...
                <h2 className="font-serif-display text-[#1C1C1C] leading-[1.1]" style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)" }}>
                  Web Design for Birmingham's Ambitious Businesses
                </h2>
              </div>
              <div className="lg:col-span-7 flex flex-col gap-6">
                <p className="text-[#1C1C1C] text-[1rem] leading-[1.82] font-sans font-light">
                  Businesses looking for reliable web design in Birmingham choose Crea Web for websites that balance professionalism, performance, and modern design. We work with companies across Birmingham to create websites that reflect their brand and support business growth.
                </p>
                <p className="text-[#7C746A] text-[0.95rem] leading-[1.82] font-sans font-light">
                  Every project is designed with mobile users, search visibility, and customer experience in mind. Whether you need a new business website or a complete redesign, we build solutions that are easy to manage and built to last.
                </p>
                <p className="text-[#7C746A] text-[0.95rem] leading-[1.82] font-sans font-light">
                  Our Birmingham web design service is ideal for companies that want a website that not only looks impressive but also helps generate enquiries and build credibility online.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 mb-16 items-start">
              <div>
                <h2 className="font-serif-display text-[#1C1C1C] leading-[1.1]" style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)" }}>
                  Web Design Services
                  <br />
                  <em className="text-[#12372A]">for Birmingham</em>
                </h2>
              </div>
              <p className="text-[#7C746A] text-[0.9rem] leading-[1.82] font-sans font-light max-w-[72ch]">
                We work with Birmingham businesses across professional services, manufacturing, retail, hospitality, and technology — delivering websites that reflect the diversity and ambition of one of the UK&rsquo;s most dynamic cities.
              </p>
            </div>
        ...
        <LocationWork projects={projects} cityName="Birmingham" />
