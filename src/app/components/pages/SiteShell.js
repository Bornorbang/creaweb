...
export function Button({ href = "/contact", children = "Start a conversation", secondary = false }) {
  return <Link href={href} className={`cw-button${secondary ? " sp-secondary" : ""}`}>{children}<span aria-hidden="true">↗</span></Link>;
}
